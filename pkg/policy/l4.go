...
// ToPolicyMapKeys converts filter into a list of PolicyKeys.
func (l4 *L4Filter) ToPolicyMapKeys(filter *L4Filter, direction trafficdirection.TrafficDirection, identityCache cache.IdentityCache, deniedIdentities cache.IdentityCache) []Key {
	keysToAdd := []Key{}
